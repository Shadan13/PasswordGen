Generates an 8-character (alphanumeric) password using the Random library in Python. Was used for a project involving developing a digital smart door lock connected to IoT.
